...
<div id="modal-add-ship" class="modal-right-util">
  ...
  <div class="content-modal">
    <div class="toolbar-modal">
      ...
      <button id="btn-delete" class="btn btn-danger"><i class="icon-trash icon-white"></i> Cập bến</button>
...
<script type="text/javascript" src="../js/ui/managerControl.js"></script>