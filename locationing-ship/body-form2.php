...
<li><a href="#"><i class="icon-resize-small"></i> Có <font color="#CC0000"><?php include("connect.php"); $sql="SELECT * FROM dvtb_tauonline";
$result=mysql_query($sql);
$dem= mysql_num_rows($result); echo $dem ?></font> tàu đang trên biển</a></li></li>
<li><a href="../sos"><i class="icon-resize-small"></i> Có <font color="#CC0000"><?php include("connect.php"); $sql="SELECT * FROM dvtb_lichtrinh";
$result=mysql_query($sql);
$dem= mysql_num_rows($result); echo $dem ?></font> tàu đang truyền tín hiệu</a></li></li>
...
echo $user ?></font> user đang online.</a></li></li>
        ...
        <ul class="nav nav-list bs-docs-sidenav">
          ...
          <li><a href="../xemmap"><i class="icon-map-marker"></i> XEM BẢN ĐỒ TÀU THUYỀN</a></li>
